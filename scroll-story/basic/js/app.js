  ...
  4: function(){
    ...
    setTimeout(function(){
      ...
      mapLayers[1].setOptions({
                ...
                cartocss:  "#{{table_name}}{[layer='line'] {line-color: white; line-width: 0.8; line-opacity: 0.3;}[layer!='line']::top {marker-fill:blue;marker-width: 4; marker-allow-overlap: true;marker-opacity: 0.7; line-opacity:1; line-width: 0; line-color: #FFFFFF; [layer = 'source']{ marker-opacity: 0.7; marker-fill:red;}}}"
              })
    },500);
  },
  5: function(){
    ...
    setTimeout(function(){
      ...
      mapLayers[1].setOptions({
                  ...
                  cartocss:  "#{{table_name}}{[layer='line'] {line-color: white; line-width: 0.8; line-opacity: 0.3;}[layer!='line']::top {marker-fill:blue;marker-width: 10;marker-allow-overlap: true;marker-opacity: 0.7; line-opacity:1; line-width: 0; line-color: #FFFFFF; [layer = 'source']{ marker-opacity: 0.7; marker-fill:red;}}}"
                })
    },500);
  },
  6: function(){
    ...
    setTimeout(function(){
        ...
        mapLayers[1].setOptions({
                sql: "SELECT * FROM buildings_1854",
                interaction: false,
                cartocss:  "#{{table_name}}{polygon-fill:white; polygon-opacity: 0.2; line-opacity:1; line-width: 0; line-color: #FFFFFF; [hazardous = true]{ polygon-opacity: 0.7; polygon-fill:red;}}"
            })
      },500);
  }
}
